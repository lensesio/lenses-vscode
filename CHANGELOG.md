...
- **Production build** — v6.2.2 shipped without required runtime configuration, causing telemetry and theming to be inactive. This release restores the correct production build.
